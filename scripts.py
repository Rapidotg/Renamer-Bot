...
│
├<b>📢 Channel : <a href='https://t.me/renamermax_robot_support'>@TeleRoidGroup</a></b>
│
...
╰──────[Thanks 😊]───⍟"""
    ...
    CONTACT_MY_DEVELOPER = "<i>Something Went Wrong! Contact in Support Group @renamermax_robot_support for Help. </i>"
